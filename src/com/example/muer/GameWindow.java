...
public class GameWindow extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		outputContent = (EditText) findViewById(com.example.muer.R.id.outputContent);
		outputButton = (Button) findViewById(com.example.muer.R.id.sendButton);
;
		...
		gameTask.execute(intent.getStringArrayExtra("CONNECTION_INFO"));
	...
	public static void writeToInput(int BackgroundColorCode, int ForegroundColorCode,String inputString) {
	...
	public static void writeToOutput(String outputString) {
		...
		final String stringToPrint = outputString;
			...
			new Thread (new Runnable() {
					...
					try {
						...
						writeOutput.println(stringToPrint);
						writeOutput.flush();
	  ...
	  private class SwipeGestureDetector 
		...
		class netTask extends AsyncTask<String,String,String> {
			...
			protected String doInBackground(String... arg0) {
				...
				scroller = (ScrollView) findViewById(com.example.muer.R.id.scrollView1);
